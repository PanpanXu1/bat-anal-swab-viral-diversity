#!/usr/bin/env python3
"""Generate the host-genus viral spectrum heatmap for previous datasets."""
...
def main() -> None:
    ...
    plot_article_clustered_panel(
        args.data_dir / "viral_spectrum_previous_datasets_by_host_genus_log10_rpm.csv",
        args.data_dir / "viral_spectrum_previous_datasets_by_host_genus_row_metadata.csv",
        args.output_dir,
        "viral_spectrum_previous_datasets_by_host_genus",
    )
